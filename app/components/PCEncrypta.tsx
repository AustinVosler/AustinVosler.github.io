      ...
      <div className=" absolute top-2 left-2 w-[496] h-60 border-8 border-yellow-500 rounded-xl">
        <div className="relative text-3xl pt-2 pl-4 pb-2 flex justify-between">
          ...
          <div className="pr-4 flex justify-end">
            <a className="pr-2" href="https://devpost.com/software/encrypta" rel="noopener noreferrer" target="_blank">
            ...
            <a href="https://github.com/jake-tattersall/encrypta" rel="noopener noreferrer" target="_blank">

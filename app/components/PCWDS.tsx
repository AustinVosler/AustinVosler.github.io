export default function PCWDS()
{
  return <div className="relative w-[512] h-64 bg-violet-900 rounded-xl">
      <div className=" absolute top-2 left-2 w-[496] h-60 border-8 border-yellow-500 rounded-xl">
        <div className="relative text-3xl pt-2 pl-4 pb-2 flex justify-between">
          ...
          <div className="pr-4 flex justify-end">
            <a className="pr-2" href="https://drive.google.com/file/d/1cf-xft8sFrx48prrL8fxd51qfWEWyD0e/view?usp=sharing" rel="noopener noreferrer" target="_blank">
            ...
            <a className="pr-2" href="https://devpost.com/software/wizard-defense-service" rel="noopener noreferrer" target="_blank">
            ...
            <a href="https://github.com/KHP8/LaunchingPoint" rel="noopener noreferrer" target="_blank">
